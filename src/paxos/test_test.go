...
func TestBasic(t *testing.T) {//(1) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
...
func TestDeaf(t *testing.T) { //(2) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
  ...
  pxa[npaxos-1].Start(1, "yyy")//yyy
  waitn(t, pxa, 1, npaxos)

  fmt.Printf("  ... Passed\n")
}

func TestForget(t *testing.T) {//(3) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
...
func TestManyForget(t *testing.T) {//(4) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
...
//
func TestForgetMem(t *testing.T) {//(5) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
...
func TestRPCCount(t *testing.T) { //(6) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
...
//
func TestMany(t *testing.T) {//(7) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
...
// 
func TestOld(t *testing.T) {//(8) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
...
//
func TestManyUnreliable(t *testing.T) {//(9) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
...
func TestPartition(t *testing.T) {//(10) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
...
func TestLots(t *testing.T) {//(11) PASSED 100 TESTS
  runtime.GOMAXPROCS(4)
