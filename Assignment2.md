# 657 Assignment 2: Primary/Backup Key/Value Service
### Part A Due: Sep 18, 11:59:59pm
### Part B Due: Sep 25, 11:59:59pm
...
assignment is a first step in the direction of making servers with
...
The 3 assignments differ in the degree of fault tolerance,
...
the view service for the correct primary (S2) and send it the
operation.
...
design, though it assumes that the view service never declares a
...
the view service that it crashed (of course, duplicate
...
But the view service must **not** change views (i.e., return
...
The acknowledgment rule prevents the view service from getting more than one
...
view in which it is primary, then the view service cannot change views, spins
...
Put()'s.  All operations should provide at-most-once semantics.
...
have completed the operation. That is, Put's should keep trying until it has
...
You should verify that are you able to see your final commit and tags
